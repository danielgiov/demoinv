...
Route::get('/petugas/qrcode/{hash}', [PetugasController::class, 'generateQRCode'])->name('petugas.qrcode');
Route::get('/petugas/barcode/{hash}', [PetugasController::class, 'generateBarcode'])->name('petugas.barcode');
