                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <!-- QR Code Button -->
                                                    <a href="{{ route('petugas.qrcode', encrypt($item->id))}}" class="btn btn-info btn-sm" title="Generate QR Code" target="_blank">
                                                        <i class="fa fa-qrcode"></i>
                                                    </a>
                                                    
                                                    <!-- Barcode Button -->
                                                    <a href="{{ route('petugas.barcode', encrypt($item->id)) }}" class="btn btn-success btn-sm" title="Generate Barcode" target="_blank">
